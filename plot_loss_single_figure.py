...
parser.add_argument('--arg-file',default='args.txt', type=str, help='args txt file')
...
itemlist = ['actor_loss_mean','critic_loss_mean','eval_reward_mean','train_episode_reward']
